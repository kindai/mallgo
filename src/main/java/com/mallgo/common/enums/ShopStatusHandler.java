 ...
 */
public class ShopStatusHandler implements TypeHandlerCallback{
    @Override
    public void setParameter(ParameterSetter parameterSetter, Object o) throws SQLException {
        parameterSetter.setLong(o == null?null:((ShopStatus)o).getId());
    }
    ...
    public Object valueOf(String s) {
        return s == null?null: ShopStatus.getById(Long.parseLong(s));
    }
}
