 ...
 */
public class OrderActionTypeHandler implements TypeHandlerCallback {
    @Override
    public void setParameter(ParameterSetter parameterSetter, Object o) throws SQLException {
        parameterSetter.setLong(o == null?null:((OrderActionType)o).getId());
    }
    ...
    public Object valueOf(String s) {
        return s == null?null: OrderActionType.getById(Long.parseLong(s));
    }
}
